...
in
{
  ...
  options = {
    ...
    modules.desktop.awesome.enable = mkEnableOption "Enable AwesomeWM home-manager module.";

    modules.desktop.awesome.defaultPrograms.terminal = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.browser  = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.research = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.editor   = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.social   = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.media    = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.games    = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.graphics = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.sandbox  = defaultProgramOptions;

    modules.desktop.awesome.defaultPrograms.files    = defaultProgramOptions;

    # modules.desktop.awesome.components = {};

    modules.desktop.awesome.widgets = {
