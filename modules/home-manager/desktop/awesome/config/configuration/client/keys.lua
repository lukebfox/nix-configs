...
local client_keys = awful.util.table.join(
  ...
  awful.key({modkey}, 'Up',
    function(c) c:relative_move(0, dpi(-10), 0, 0) end,
  ...
  awful.key({modkey}, 'Left',
    function(c) c:relative_move(dpi(-10), 0, 0, 0) end,
  ...
  awful.key({modkey, 'Control'}, 'Left',
    function(c) if c.width > 10 then c:relative_move(0, 0, dpi(-10), 0) end end,
