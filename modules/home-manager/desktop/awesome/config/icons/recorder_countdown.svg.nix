...
in writeText "awesome-icons-recorder_countdown" ''
...
<svg
  ...
  <g
    ...
    <path
       ...
       style="fill:#${theme.base07-hex};fill-opacity:1;fill-rule:evenodd;stroke-width:0.2583026"
       ...
       id="path858" />
    <path
       style="fill:#${theme.base0C-hex};fill-opacity:1;fill-rule:evenodd;stroke-width:0.2583026"
