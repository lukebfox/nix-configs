...
-- TODO move to nix awesomewm home-manager module
local wall_config = {
	-- Wallpaper directory. The default is:
	-- local wall_config.wall_dir = os.getenv('HOME') .. 'Pictures/Wallpapers/'
	wall_dir = filesystem.get_configuration_dir() .. 'wallpapers/',

	valid_picture_formats = {"jpg", "png", "jpeg"},

	-- Table mapping schedule to wallpaper filename
	wallpaper_schedule = {
        ['00:00:00'] = 'unsplash-cyberpunk.jpg',
	    ['06:22:00'] = 'unsplash-brutalism.jpg',
        ['10:22:00'] = 'unsplash-greenery.jpg',
        ['14:22:00'] = 'unsplash-cyberpunk2.jpg',
        ['18:22:00'] = 'unsplash-ocean.jpg'
	},
...
local update_wallpaper = function(wall_name)
	local wallpaper = wall_config.wall_dir .. wall_name
...
local wall_updater = gears.timer {
	...
	autostart = true,
	call_now  = true,
	callback  = function() awesome.emit_signal('component::change_wallpaper') end
}

-- Update wallpaper here and update the timeout for the next schedule
awesome.connect_signal('component::change_wallpaper', function()
