...
local left_panel  = require('layouts.left_panel')
local top_panel   = require('layouts.top_panel')
local right_panel = require('layouts.right_panel')
    ...
    if s.selected_tag then
      ...
      if s.right_panel then
        ...
        elseif
          ...
          focused.right_panel_show_again
        then
          focused.right_panel:toggle()
...
tag.connect_signal('property::selected', function(t) update_bars_visibility() end)
