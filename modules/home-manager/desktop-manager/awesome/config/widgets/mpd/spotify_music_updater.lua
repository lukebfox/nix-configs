--TODO nixify due to internal python/bash script
local awful   = require('awful')
local gears   = require('gears')
local naughty = require('naughty')

local icons      = require('icons')
local ui_content = require('widgets.music.content')
...
END
    ...
    awful.spawn.easy_async_with_shell(set_volume, function(stdout) end)
end
    ...
    gears.table.join(
        awful.button({}, 1, nil, function()
            awful.spawn.easy_async_with_shell(
                ...
                function() update_all_content() end
            )
        end)
    )
)
